    ...
    function moveObject
        ...
        if player == 1
            ...
            if p1HitTest == 1
                ...
                ship1Positions(1:2) = fscanf(player1, '%f %f', 2)';
                fclose(player1);
            ...
            %--------------------------------------------%
            player1 = fopen('1.txt', 'r');
            ship1Positions(1) = fscanf(player1, '%f', 1);
            ship1Positions(2) = fscanf(player1, '%f', 1);
            fclose(player1);
        ...
        elseif player == 2
            ...
            if p2HitTest == 1
                ...
                ship2Positions(1) = fscanf(player2, '%f', 1);
                ship2Positions(2) = fscanf(player2, '%f', 1);
                fclose(player2);
...
%-----------------------------------------------------------------%
    player2 = fopen('2.txt', 'r');
    ship2Positions = fscanf(player2, '%f %f', [2 inf])';
    fclose(player2);
    draw_object(mainAxis, ship2, ship2Positions(1:2));
%-------------------------------------------------------------------------%
...
%-------------------------------------------------------------------------%
    ...
    %---------------------------------%
    player1 = fopen('1.txt', 'r');
    tempShip1Positions = fscanf(player1, '%f %f', [2 inf])';
    fclose(player1);
    draw_object(mainAxis, ship1, tempShip1Positions(1:2));
    %---------------------------------%
    end
    end
%-------------------------------------------------------------------------%
